...
const events = [
  ...
  createEvent({
    ...
    visualMode: "document",
    accent: "#7c5a68",
    cover: createImageAsset("assets/covers/nov-textile-cover.png", "11月雙職業例會封面", {
      className: "document-cover",
    }),
    summary:
      "11 月並不是沒有活動，而是同月有兩場職業例會。這一版依照月份編排，把紡織與區塊鏈兩場內容併進同一個月度章節，保留時間線完整性。",
    highlights: ["紡織", "區塊鏈", "月內雙場"],
    availability:
      "目前可用素材以兩場例會的感謝狀與簽到資料為主，後續最適合補上講者台上照、桌次交流或合照。",
    gallery: [
      createImageAsset("assets/covers/nov-textile-cover.png", "紡織例會感謝狀", {
        caption: "11 月上旬的紡織例會，先以現有文件封面保留這場職業主題活動。",
      }),
      createImageAsset("assets/covers/nov-blockchain-cover.png", "區塊鏈職業例會感謝狀", {
        caption: "11 月下旬的區塊鏈職業例會，作為同月份第二場職業交流內容。",
      }),
    ],
  }),
  createDocumentEvent({
