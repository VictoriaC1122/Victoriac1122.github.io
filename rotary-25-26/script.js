const events = [
  ...
  },
  {
    ...
    cover: {
      ...
      alt: "2026年4月淨灘例會多人清理海灘畫面",
    },
    summary:
      "4 月已整理出一批真實活動照，這一版優先挑選多人行動畫面、海邊氛圍照與代表性人物構圖，讓整體更像現場紀錄。",
    highlights: ["淨灘例會", "海邊行動", "多人活動照"],
    availability: "這個月份已具備實拍素材，後續可再換成更明確的大合照版本。",
    gallery: [
      {
        kind: "image",
        src: "assets/photos/april-beach-4.jpg",
        alt: "多人在海邊淨灘",
        caption: "多人一起清理海灘的畫面，很適合放在這個月份的主視覺位置。",
      },
      {
        kind: "image",
        src: "assets/photos/april-beach-5.jpg",
        alt: "淨灘互動畫面",
        caption: "讓活動不只是一張風景照，而是真的看見大家在做事。",
      },
      {
        kind: "image",
        src: "assets/photos/april-beach-1.jpg",
        alt: "海邊活動氛圍照",
        caption: "保留海邊地景與活動氛圍，讓畫面更有展覽感。",
      },
      {
        kind: "image",
        src: "assets/photos/april-beach-2.jpg",
        alt: "淨灘例會現場畫面",
        caption: "補足近距離的參與畫面，讓例會主題更明確。",
      },
      {
        kind: "image",
        src: "assets/photos/april-beach-3.jpg",
        alt: "海邊人物照",
        caption: "保留活動中的人物記憶，作為月度故事的收尾。",
      },
    ],
    links: [],
  },
  {
    ...
    summary:
      "5 月目前尚未找到可直接放入網站的圖像素材，因此先以數位直播主題的視覺保留月份位置與故事走向。",
    highlights: ["直播例會", "數位形式", "年度轉場"],
    availability: "建議後續補入直播畫面截圖、工作照或合照。",
    gallery: [
      {
        kind: "generated",
        theme: "stream",
        ...
        title: "直播例會",
        month: "2026.05",
        caption: "先用數位感占位視覺保留 5 月版位，等待更完整的活動畫面。",
      },
    ],
    links: [],
  },
