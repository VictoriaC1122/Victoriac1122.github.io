    ...
    translations: {
      "zh-TW": {
        ...
        home: {
          ...
          collage: {
            ...
            main: {
              kicker: "活動頁",
              title: "年度活動時間軸",
              alt: "2025 年 6 月交接典禮手冊人物合照",
            },
            july: {
              alt: "2025 年 7 月幹部訓練手冊人物合照",
              title: "聯合幹部訓練",
            },
            may: {
              alt: "2026 年 5 月直播講座例會手冊人物合照",
              title: "直播講座例會",
            },
            note: {
              label: "頁面風格",
        ...
        activities: {
          ...
          spotlight: {
            first: {
              title: "手冊對齊",
              body: "名稱和日期都先對照交接典禮手冊。",
            },
            second: {
              title: "照片順序",
              body: "先放大合照，再放兩位會長和最能代表活動的畫面。",
            },
            third: {
              title: "手機順讀",
              body: "一路往下滑就能看完整年，不用來回切頁。",
            },
          },
          archive: {
            eyebrow: "年度時間軸",
      ...
      en: {
        ...
        home: {
          ...
          collage: {
            aria: "Featured scenes from the year",
            main: {
              kicker: "Activities",
              title: "Yearly Activity Timeline",
              alt: "Group portrait from the June handover handbook",
            },
            july: {
              alt: "Group portrait from the July leadership training handbook",
              title: "Joint Leadership Training",
            },
            may: {
              alt: "Group portrait from the May livestream talk handbook",
              title: "Livestream Talk Meeting",
            },
            note: {
              label: "Visual Style",
          ...
          portal: {
            ...
            leaders: {
              ...
              kicker: "Leaders",
              title: "Leaders Page",
              body: "Browse formal profiles, photos, and year-in-review notes for Hannah Hung and Victoria Cheng.",
              metaHannah: "Hannah",
        ...
        leaders: {
          ...
          spotlight: {
            first: {
              title: "Community",
              body: "They led the fellowship as a team that can work together and support one another.",
            },
            second: {
              title: "Passing it on",
              body: "From handover to welcome events, the year kept relationships and experience moving forward.",
            },
            third: {
              title: "Activities",
              body: "Different meetings and service projects kept members involved throughout the year.",
            },
          },
          section: {
            eyebrow: "Profiles",
