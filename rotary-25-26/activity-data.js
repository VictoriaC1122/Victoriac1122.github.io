(() => {
  ...
  const activityEvents = [
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "9 月的歌唱例會放在浪漫屋視聽歌唱城，想上台的人可以先報名，再決定要不要參賽；想來聽歌、拍照、一起唱，也都很適合。正式比賽後，還留了一整段自由歡唱時間。",
        "September's singing meeting takes place at Romantic House KTV. Anyone who wants to step on stage can register first and decide later whether to compete, while everyone else is welcome to come listen, take photos, and join the singing. After the contest, the room stays open for a long open-sing session.",
      ),
      highlights: localizedList(
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "10 月的游泳例會分成兩段進行，先在 Ramble Cafe 報到、聯誼和合照，再一起前往玉泉公園溫水游泳池下水活動。",
        "October's swimming meeting unfolds in two parts: first a meetup, mingling, and group photo at Ramble Cafe, followed by the pool session at Yuquan Park Heated Pool.",
      ),
      highlights: localizedList(
        ["咖啡聯誼", "Cafe gathering"],
        ["泳池活動", "Pool session"],
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "11 月的紡織例會，邀請賴綉丹帶大家做一場節慶手作。從講師分享、材料操作到完成作品，節奏很完整，也留了足夠時間慢慢做。",
        "November's textile meeting invites Lai Hsiu-Dan to lead a festive handcraft session. The afternoon moves from the speaker's sharing into materials, making, and finishing the work at an easy, complete pace.",
      ),
      highlights: localizedList(
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "11 月的捐血例會把公益行動排進例會日程。想捐血的夥伴可以直接到場，不方便捐血的人，也能留在現場一起幫忙。",
        "November's blood donation meeting turns a regular gathering into a service day. Members who want to donate can come directly, and those who cannot donate can still help on site.",
      ),
      highlights: localizedList(
        ["公益參與", "Public service"],
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "這場區塊鏈例會邀請涂立青 Larry Tu 分享他如何把區塊鏈、產品策略與真實產業接在一起，讓題目不只停在概念，也回到工作現場裡。",
        "This blockchain meeting invites Larry Tu to share how he connects blockchain, product strategy, and real industries, bringing the topic back from abstraction into practical work.",
      ),
      highlights: localizedList(
        ["區塊鏈", "Blockchain"],
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "12 月的送餐例會在永老師烹飪教室集合，先一起做熱食、打包整隊，傍晚再步行前往艋舺公園與台北車站，把餐點親手送出去。",
        "December's meal service gathers at Chef Yong Cooking Studio for cooking, packing, and team coordination before walking to Monga Park and Taipei Main Station to hand out the meals in person.",
      ),
      highlights: localizedList(
        ["街友送餐", "Meal service"],
    ...
    createPhotoEvent({
      ...
      summary: localized(
        "5 月的雙北例會把主題放在自媒體與直播產業，邀請前直播主兼經紀人沐飛，從業界經驗出發，聊這個領域的工作樣貌、入行判斷和實際路徑。",
        "May's joint Taipei and New Taipei meeting focuses on self-media and the livestream industry, with former livestream host and talent manager Mu-Fei sharing what the work looks like, how people judge whether it suits them, and how a path into the field can begin.",
      ),
      highlights: localizedList(
        ["自媒體", "Self-media"],
